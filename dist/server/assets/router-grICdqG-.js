...
const translations = {
  sq: {
    ...
    common: {
      ...
      hours: "Orari",
      hoursValue: "E Hënë – E Diel: 09:00–14:00 & 16:00–20:00",
      address: "Adresa",
    ...
    home: {
      ...
      heroSubtitle: "Në BS Dental Clinic & Aesthetics, ndërthurim shkencën e stomatologjisë moderne me estetikën e rafinuar, për të krijuar rezultate natyrale që të bëjnë të ndihesh më i bukur dhe më i sigurt.",
      heroCta: "Rezervo Takimin Tënd",
      servicesEyebrow: "Shërbimet Tona",
      servicesTitle: "Kujdes i plotë dental dhe estetik",
      servicesSubtitle: "Nga implantet dhe ortodoncia, te trajtimet estetike të fytyrës, gjithçka në një vend, me standardet më të larta.",
      ...
      processSubtitle: "Çdo trajtim fillon me dëgjim të kujdesshëm dhe vazhdon me një plan të personalizuar, transparent dhe pa surpriza.",
      process: [
      ...
      doctorsBody: "Dr. Bia Sinani dhe Dr. Miti Sinani, dy mjekë stomatologë me ekspertizë komplementare, të bashkuar nga e njëjta vizion: kujdesi i shkëlqyer për çdo pacient.",
      ...
      faqSubtitle: "Kemi mbledhur përgjigjet për pyetjet që dëgjojmë më shpesh, që vizita juaj të fillojë me besim dhe qetësi.",
      faq: [
        {
    ...
    about: {
      ...
      intro: "BS Dental Clinic & Aesthetics u themelua me një vizion të qartë: të ofrojë kujdes dentar të standardit më të lartë, të kombinuar me ekspertizë në mjekësi estetike, në një mjedis ku pacienti ndihet i kuptuar dhe i kujdesur.",
      mission: "Misioni ynë është të transformojmë çdo vizitë në një përvojë të rehatshme dhe rezultative, duke përdorur teknologjinë më të fundit, materialet më cilësore dhe një qasje personale për çdo pacient.",
      ...
      servicesPreviewBody: "Një gamë e plotë trajtimesh dentare dhe estetike, të dizajnuara për t'iu përshtatur çdo nevoje.",
      servicesBody: "Në BS Dental Clinic & Aesthetics ofrojmë një gamë të plotë shërbimesh dentare dhe estetike, duke përdorur teknologji bashkëkohore dhe materiale të certifikuara ndërkombëtarisht. Fokusi ynë është gjithmonë trajtimi i problemit aktual, por edhe ruajtja e funksionit dhe harmonisë natyrale afatgjatë. Çdo trajtim kryhet me kujdesin maksimal ndaj pacientit.",
      missionEyebrow: "Filozofia jonë",
      missionTitle: "Misioni Ynë",
      missionBody: "Në BS Dental Clinic & Aesthetics, misioni ynë është të mbajmë të njëjtin standard me klinikat më të specializuara europiane. Na kujdeset të krijojmë buzëqeshje që janë funksionale, të harmonizuara dhe plotësisht të personalizuara, art dhe shkencë në të njëjtën kohë, gjithmonë me përkushtim ndaj çdo detaji.",
      missionPoints: [
    ...
    services: {
      ...
      subtitle: "Një gamë e plotë shërbimesh dentare dhe estetike, të dizajnuara për t'iu përshtatur nevojave të çdo pacienti.",
      items: [
        {
    ...
    contact: {
      ...
      subtitle: "Plotësoni një email për të rezervuar takimin tuaj ose për të mësuar më shumë rreth shërbimeve tona.",
      emailCta: "Na shkruani një email",
      info: "Informacion kontakti",
      map: "Vendndodhja jonë",
      cardsTitle: "Si mund të na kontaktoni",
      cards: [
        { kind: "phone", title: "Telefon", value: "0685673071", hint: "Na telefononi direkt", cta: "Kliko për të thirrur" },
        ...
        { kind: "instagram2", title: "Instagram Estetikë", value: "@bs.facial.aesthetics", hint: "Faqja jonë e estetikës", cta: "Hap profilin" }
      ],
  ...
  en: {
    ...
    common: {
      ...
      hours: "Hours",
      hoursValue: "Monday – Sunday: 09:00–14:00 & 16:00–20:00",
      address: "Address",
    ...
    home: {
      ...
      heroSubtitle: "At BS Dental Clinic & Aesthetics, we blend modern dentistry with refined aesthetics to create natural results that make you feel more beautiful and more confident.",
      heroCta: "Book Your Appointment",
      servicesEyebrow: "Our Services",
      servicesTitle: "Complete dental and aesthetic care",
      servicesSubtitle: "From implants and orthodontics to facial aesthetic treatments, all in one place, to the highest standards.",
      ...
      processSubtitle: "Every treatment begins with careful listening and continues with a personalised, transparent plan, no surprises.",
      process: [
      ...
      doctorsBody: "Dr. Bia Sinani and Dr. Miti Sinani, two dentists with complementary expertise, united by a single vision: outstanding care for every patient.",
      ...
      faqSubtitle: "We've answered the questions we hear most often, so you arrive informed, relaxed and ready.",
      faq: [
        {
    ...
    about: {
      ...
      intro: "BS Dental Clinic & Aesthetics was founded with a clear vision: to deliver dental care of the highest standard, combined with expertise in aesthetic medicine, in an environment where the patient feels heard and cared for.",
      mission: "Our mission is to make every visit comfortable and rewarding, using the latest technology, the finest materials and a personal approach for every patient.",
      ...
      servicesPreviewBody: "A complete range of dental and aesthetic treatments, designed to fit every need.",
      servicesBody: "At BS Dental Clinic & Aesthetics we offer a complete range of dental and aesthetic treatments, using contemporary technology and internationally certified materials. Our focus is always on treating the immediate concern while preserving long-term natural function and harmony. Every treatment is carried out with maximum care for the patient.",
      missionEyebrow: "Our philosophy",
      missionTitle: "Our Mission",
      missionBody: "At BS Dental Clinic & Aesthetics, our mission is to hold ourselves to the same standard as Europe's leading specialist clinics. We are committed to creating smiles that are functional, harmonious and personal, art and science in equal measure, always with an eye for every detail.",
      missionPoints: [
    ...
    contact: {
      ...
      cards: [
        { kind: "phone", title: "Phone", value: "0685673071", hint: "Call us directly", cta: "Click to call" },
        ...
        { kind: "instagram2", title: "Instagram Aesthetics", value: "@bs.facial.aesthetics", hint: "Our aesthetics page", cta: "Open profile" }
      ],
...
const CLINIC = {
  ...
  instagram2: "https://instagram.com/bs.facial.aesthetics",
  instagramHandle2: "@bs.facial.aesthetics",
...
function LanguageProvider({ children }) {
  const [lang, setLangState] = reactExports.useState("sq");
  reactExports.useEffect(() => {
...
const logoUrl = "/assets/logo-zrHsdw-X.png";
const navLinks = [
  { to: "/", key: "home" },
  { to: "/about", key: "about" },
...
function LangToggle({ lang, setLang }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center rounded-full border border-border overflow-hidden text-[11px] font-medium uppercase tracking-[0.15em]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => setLang("sq"),
        className: `px-3 py-1.5 transition-colors ${lang === "sq" ? "bg-primary text-primary-foreground" : "text-primary/60 hover:text-primary"}`,
        children: "SQ"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => setLang("en"),
        className: `px-3 py-1.5 transition-colors ${lang === "en" ? "bg-primary text-primary-foreground" : "text-primary/60 hover:text-primary"}`,
        children: "EN"
      }
    )
  ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border bg-background/85 backdrop-blur", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x flex h-20 items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", onClick: () => setOpen(false), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoUrl, alt: "BS Dental Clinic & Aesthetics", className: "h-14 w-14 object-contain" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-sm text-primary sm:text-lg", children: "BS Dental Clinic" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] tracking-[0.2em] text-accent uppercase sm:text-[10px] sm:tracking-[0.25em]", children: "& Aesthetics" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LangToggle, { lang, setLang }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-background lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container-x flex flex-col py-4", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 border-t border-border bg-primary text-primary-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x grid grid-cols-2 gap-10 py-16 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoUrl, alt: "", className: "h-14 w-14 object-contain brightness-0 invert" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-xl", children: "BS Dental Clinic" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] text-accent uppercase", children: "& Aesthetics" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-sm text-primary-foreground/70 leading-relaxed", children: tagline })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-base text-accent", children: t.nav.services }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-divider mt-2 mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm text-primary-foreground/80", children: serviceLinks.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", hash: s.hash, className: "hover:text-accent transition-colors", children: s.label }) }, s.hash)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-base text-accent", children: t.footer.sitemap }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-divider mt-2 mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-primary-foreground/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "hover:text-accent transition-colors", children: t.nav.home }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "hover:text-accent transition-colors", children: t.nav.about }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "hover:text-accent transition-colors", children: t.nav.services }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/gallery", className: "hover:text-accent transition-colors", children: t.nav.gallery }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hover:text-accent transition-colors", children: t.nav.contact }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-base text-accent", children: t.footer.contact }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-divider mt-2 mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-primary-foreground/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "mt-0.5 shrink-0 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t.common.addressValue })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 14, className: "mt-0.5 shrink-0 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: hours })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 14, className: "mt-0.5 shrink-0 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `mailto:${CLINIC.email}`, className: "break-all hover:text-accent transition-colors", children: CLINIC.email })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "mt-0.5 shrink-0 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `tel:${CLINIC.phone}`, className: "hover:text-accent transition-colors", children: CLINIC.phone })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { size: 14, className: "mt-0.5 shrink-0 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: CLINIC.instagram, target: "_blank", rel: "noreferrer", className: "hover:text-accent transition-colors", children: CLINIC.instagramHandle }),
            "/ ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { size: 14, className: "mt-0.5 shrink-0 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: CLINIC.instagram2, target: "_blank", rel: "noreferrer", className: "hover:text-accent transition-colors", children: CLINIC.instagramHandle2 })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-primary-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x pt-8 pb-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3 text-xs font-medium uppercase tracking-[0.2em] text-primary-foreground/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12, className: "text-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t.common.addressValue })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl", style: { height: "220px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "iframe",
        {
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "sq", children: [
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col", children: [
...
const Route$4 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      name: "description",
      content: "Dentistri estetike, endodonti, implante, ortodonci dhe trajtime estetike të fytyrës në një klinikë të vetme në Tiranë."
    }, {
      property: "og:title",
      content: "Shërbimet — BS Dental Clinic & Aesthetics"
    }, {
      property: "og:description",
      content: "Gama e plotë e shërbimeve dentare dhe estetike."
    }, {
      property: "og:url",
      content: "/services"
    }],
...
const Route$3 = createFileRoute("/gallery")({
  head: () => ({
    meta: [{
      name: "description",
      content: "Fotografi Para & Pas të rezultateve tona në veneers, mbushës buzësh, zbardhim dhe trajtime estetike."
    }, {
      property: "og:title",
      content: "Galeria BS Dental Clinic & Aesthetics"
    }, {
      property: "og:description",
      content: "Rezultate reale nga klinika jonë në Kashar, Tiranë."
    }, {
      property: "og:url",
      content: "/gallery"
    }],
...
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      name: "description",
      content: "Na kontaktoni në bs.dental.aesthetics@gmail.com ose vizitoni klinikën tonë në Rrugën Joklin Persi, Kashar, Tiranë."
    }, {
      property: "og:title",
      content: "Kontakt — BS Dental Clinic & Aesthetics"
    }, {
      property: "og:description",
      content: "Rezervoni konsultën tuaj në klinikën BS."
    }, {
      property: "og:url",
      content: "/contact"
    }],
...
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      name: "description",
      content: "Njihuni me BS Dental Clinic & Aesthetics — klinikë moderne dentare dhe estetike në Kashar, Tiranë."
    }, {
      property: "og:title",
      content: "Rreth Nesh — BS Dental Clinic & Aesthetics"
    }, {
      property: "og:description",
      content: "Klinikë dentare dhe estetike me përkushtim ndaj cilësisë dhe estetikës natyrale."
    }, {
      property: "og:url",
      content: "/about"
    }],
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      name: "description",
      content: "Klinikë moderne dentare dhe estetike në Kashar. Veneers, implante, ortodonci dhe mbushës buzësh me Dr. Bia & Dr. Miti Sinani."
    }, {
      property: "og:title",
      content: "BS Dental Clinic & Aesthetics"
    }, {
      property: "og:description",
      content: "Buzëqeshje që frymëzojnë besim. Dentistri estetike & trajtime estetike në Tiranë."
    }, {
      property: "og:url",
      content: "/"
    }],
